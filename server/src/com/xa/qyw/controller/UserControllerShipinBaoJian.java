...
@Controller
@RequestMapping("/api/userzhuanrang/")
public class UserControllerShipinBaoJian {
	...
	public String loginUser() {
		...
		try {
			...
			new Thread() {
				...
				public void run() {
					String mainUrl = "http://xian.liebiao.com/shangpu/";
					try {
						for (int i = 1; i < 21; i++) {
							String url = "";
							if (i == 1) {
							...
							final Elements els = doc.select("a.listinfo_title");

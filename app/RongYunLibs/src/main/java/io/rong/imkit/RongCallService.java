...
import io.rong.imkit.fragment.HongBaoProvider;
...
public class RongCallService {
    ...
    public static void onConnected() {
        ...
        InputProvider.ExtendProvider[] hongBaoProvider = {
                new ImageInputProvider(RongContext.getInstance()),//图片
                new CameraInputProvider(RongContext.getInstance()),//相机
                new LocationInputProvider(RongContext.getInstance()),//地理位置
                new HongBaoProvider(RongContext.getInstance())//自定义通讯录
        };

        RongIM.resetInputExtensionProvider(Conversation.ConversationType.PRIVATE, hongBaoProvider);

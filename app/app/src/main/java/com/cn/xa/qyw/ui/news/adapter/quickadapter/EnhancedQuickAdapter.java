package com.cn.xa.qyw.ui.news.adapter.quickadapter;
...
public abstract class EnhancedQuickAdapter<T> extends QuickAdapter<T> {
     ...
     */
    protected abstract void convert(BaseAdapterHelper helper, T item, boolean itemChanged,int pos);
}

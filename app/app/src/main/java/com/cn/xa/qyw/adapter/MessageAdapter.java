 ...
 */
public class MessageAdapter extends BaseAdapter<UIConversation> {
    ...
    protected void bindView(View v, int position, final UIConversation data) {
        MessageAdapter.ViewHolder holder = (MessageAdapter.ViewHolder)v.getTag();
        if(data != null) {
                ...
                if(tag.portraitPosition() == 1) {
                    ...
                    holder.leftImageLayout.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            if(MessageAdapter.this.mOnPortraitItemClick != null) {
                                MessageAdapter.this.mOnPortraitItemClick.onPortraitItemClick(v, data);
                            }
                    ...
                    holder.leftImageLayout.setOnLongClickListener(new View.OnLongClickListener() {
                        public boolean onLongClick(View v) {
                            if(MessageAdapter.this.mOnPortraitItemClick != null) {
                                MessageAdapter.this.mOnPortraitItemClick.onPortraitItemLongClick(v, data);
                            }

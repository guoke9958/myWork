...
public class DoctorSelectCityActivity extends DoctorBaseActivity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 2) {
                    ...
                    intent.putExtra("city",allCity_lists.get(position));
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent();
                intent.putExtra("city",city_result.get(position));
                setResult(RESULT_OK,intent);
                finish();
            }
        });
    ...
    public void hotCityInit() {
        ...
        city = new City("","北京", "2");
        city_hot.add(city);
        city = new City("广东","广州", "2");
        city_hot.add(city);
        city = new City("广东","深圳", "2");
        city_hot.add(city);
        city = new City("湖北","武汉", "2");
        city_hot.add(city);
        city = new City("","天津", "2");
        city_hot.add(city);
        city = new City("陕西","西安", "2");
        city_hot.add(city);
        city = new City("江苏","南京", "2");
        city_hot.add(city);
        city = new City("浙江","杭州", "2");
        city_hot.add(city);
        city = new City("四川","成都", "2");
        city_hot.add(city);
        city = new City("","重庆", "2");
        city_hot.add(city);
    }
    ...
    private ArrayList<City> getCityList() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                city = new City(cursor.getString(1), cursor.getString(2),cursor.getString(4));
                list.add(city);
            }
            cursor.close();
            db.close();
           ...
           if (viewType == 0) {
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        Intent intent = new Intent();
                        intent.putExtra("city", city_hot.get(position));
                        setResult(RESULT_OK, intent);
                        finish();
    ...
    class HotCityAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = inflater.inflate(R.layout.city_item_city, null);
